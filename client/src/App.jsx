      ...
      <Navbar />
        ...
        <section id="home" className="home-container">
          ...
          <div className="home-content-wrapper">
            <div className="circular-content">
              ...
              <div className="home-header">Aditya <span className="heart-symbol">💑</span> Lakshmi</div>
              ...
              <div className="haldi-content">
                <div className="section-title haldi-title">
                  <div className="title-decoration">
                    <img src="/mandala-decoration.jpg" alt="Mandala" className="mandala-img" />
                  </div>
        ...
        <section id="travel-details" className="section" data-bg="/TravelDetails.webp">
          <div className="content">
            ...
            <ul>
              <li><strong>By Air:</strong> {eventData.travel.air}</li>
            ...
            <ul>
              ...
              <li>Weather Forecast: Sunny and warm</li>
